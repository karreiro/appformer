...
public class HtmlEditorServiceImplTest {
    ...
    public void testReadAllString() throws Exception {
        ...
        final String actualString = htmlEditorService.readAllString(path);
    ...
    public void testWrite() throws Exception {
        ...
        doReturn(expectedPath).when(htmlEditorService).save(path, content, null, null);

        final Path actualPath = htmlEditorService.write(path, content);
